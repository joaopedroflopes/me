        ...
        <div className='about'>
            <div>
                ...
                <p>
                    ...
                    <br /><br />
                    While studying, I had the opportunity <span className='highlight-text' > to work and gain experience</span> as sole developer (which currently I still am) of the backend for SurfRec. I also got to experience the life as a frontend as a Junior Developer Apprentice @ Sky Technology Centre for two months. <span className='highlight-text'  >Right now</span> I&apos;m working as a backend developer @ Emvenci on my thesis “Automation in Cybersecurity Awareness”.
                    <br /><br />
